...
void *InitEnContext(void *rawqueue, void *packetQueue)
{
	...
	aCodec = avcodec_find_encoder(AV_CODEC_ID_WMAV2);  
    ...
    pencontext->pVCodecCtx->pix_fmt = AV_PIX_FMT_YUV420P;
    ...
    pencontext->pACodecCtx->codec_id = 86024;
    pencontext->pACodecCtx->sample_fmt = 8;
    pencontext->pACodecCtx->sample_rate = 44100;
    pencontext->pACodecCtx->bit_rate = 47994;
